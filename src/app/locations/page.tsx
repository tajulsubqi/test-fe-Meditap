...
const LocationsPage = () => {
  ...
  return (
    <Container>
      ...
      <div className="grid gap-2 sm:grid-cols-2 md:grid-cols-3 hover:bg-gradient-black-red hover:text-white duration-300 lg:grid-cols-4 xl:grid-cols-5 w-full text-black">
